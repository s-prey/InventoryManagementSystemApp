...
/** This class is used as a java fx controller to modify existing products with parts via the javafx GUI screen.*/
public class ModifyProductController implements Initializable {
    ...
    /** This is the pass product to modify method.
     This method passes the selected product data from the main menu screen for the modify product controller class.
     @param product modified product to pass data from
     */
    ...
    /** This is the initialize method.
     This method is used to initialize data for the modify product controller class.
    ...
    //Populates left Product information fields from selected product to modify
    productIDTxt.setPromptText(Integer.toString(productToModify.getId()));
    ...
    void onActionSaveProduct(ActionEvent event) throws IOException {
        ...
        try {
            ...
            alert.setTitle("Error");
            alert.setHeaderText("Add product error");
            alert.setContentText("Product input format error! Please enter product data in the correct format.");
            alert.showAndWait();
            return;
        }
